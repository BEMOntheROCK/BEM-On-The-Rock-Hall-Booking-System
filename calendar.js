...
window.generateInvoice = function(id) {
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;}body{font-family:'Inter',sans-serif;background:#fff;color:#111;padding:48px;max-width:720px;margin:0 auto;}
    ...
    .inv-header h1{font-family:'Playfair Display',serif;font-size:28px;}.inv-header p{font-size:12px;color:#666;margin-top:4px;}
    ...
    .inv-section{margin-bottom:28px;}.inv-section h3{font-size:10px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:#ECA820;margin-bottom:12px;border-bottom:1px solid #eee;padding-bottom:6px;}
    .inv-row{display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f5f5f5;font-size:13px;}.inv-row span:first-child{color:#555;}.inv-row span:last-child{font-weight:600;}
    .inv-total{background:#fafafa;border-radius:8px;padding:16px;margin-top:8px;display:flex;justify-content:space-between;align-items:center;}
    .inv-total span:first-child{font-size:13px;color:#555;}.inv-total span:last-child{font-size:22px;font-family:'Playfair Display',serif;font-weight:700;color:#ECA820;}
    .inv-footer{margin-top:40px;font-size:11px;color:#999;text-align:center;border-top:1px solid #eee;padding-top:16px;}
    @media print{body{padding:24px;}}
  </style></head><body>
  <div class="inv-header"><div><h1>BEM On The Rock</h1><p>Hall Booking Invoice</p><p style="margin-top:8px;color:#aaa;font-size:11px;">Generated: ${new Date().toLocaleDateString('en-MY',{day:'numeric',month:'long',year:'numeric'})}</p></div><span class="inv-badge">${payStatus}</span></div>
